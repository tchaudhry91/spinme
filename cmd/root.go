...
func init() {
	...
	//rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.spinme.yaml)")
}
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".spinme" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".spinme")
	}
